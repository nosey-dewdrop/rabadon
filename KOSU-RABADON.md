...
**Bilinen ve ölçülmüş açık: %4'lük uzunluk bağımlılığı duruyor.** R1.3 kapandığında GOAL 6 kararlı biçimde %3.5–4.9 okuyor ve bu gürültü değil — `last_ledger_mode()`'un tam-dosya yedek yolu (+78.7 µs, `reports/R1.3/PROFIL.md`). Eski cetvel bunu sıfırdan ayırt edemiyordu; yeni cetvel ayırt ediyor. Tavan %10 olduğu için tur kabul edildi, ama değişmez ("hot-path maliyeti oturum uzunluğuna bağlı olamaz") tam anlamıyla sağlanmış değil. R7 daemon'ı süreç başlatmayı kaldırdığında bu oran **büyüyecek** (payda küçülüyor), o yüzden R7 bunu kendi kabulünde yeniden ölçer.
